...
import { useSyncProjectMemoryDispatch } from "../../kernels/utils/write-dialog-api-requests";
...
const MemorySetting = () => {
    ...
    const syncProjectMemory = useSyncProjectMemoryDispatch();
    const handleSyncProject = async () => {
        syncProjectMemory();
    };

    const memoryTypeContent = `If 'Project' is selected, when you sync project data, 
    you maybe need to wait for a while to see the updated data.
    `
