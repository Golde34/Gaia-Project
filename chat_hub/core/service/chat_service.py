...
async def push_and_save_bot_message(message: str, dialogue_id: str, query: QueryRequest) -> None:
    dialogue = await dialogue_service.get_dialogue_by_id(query.user_id, dialogue_id)
    ...
    print("Bot message stored with ID:", bot_message_id)
