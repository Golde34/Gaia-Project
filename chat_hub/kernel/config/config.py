...
LLM_DEFAULT_MODEL = os.getenv('LLM_DEFAULT_MODEL', 'gemini-2.5-pro')
LLM_SUB_MODEL = os.getenv('LLM_SUB_MODEL', 'gemini-2.5-flash')
SLM_MODEL = os.getenv('SLM_MODEL', 'gemini-2.5-flash-lite')
