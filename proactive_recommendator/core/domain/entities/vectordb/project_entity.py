...
class Project():
    ...
    def __repr__(self):
        return f"Project(connection_name={self.connection_name}, label={self.label}, name={self.name}, keywords={self.keywords}, example={self.example}, description={self.description})" 
